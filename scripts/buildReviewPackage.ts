...
const files: Record<string,string> = {
  'README_REVIEW.md': `TONK.MEM is a TON meme token launchpad.\n\nThe product supports manual wallet signing, a 5 TON test target, an 8888 TON production target, and a post-migration liquidity path.\n\nVerified locally:\n- contracts build\n- sandbox buy/mint flow\n- TonConnect payload preparation\n- production build\n- security check\n\nNot live-proven yet:\n- mainnet deploy\n- real buy\n- migration liquidity proof\n- LP proof\n- full indexer proof\n`,
  ...
  'RISK_REGISTER.md': `Main risks: live deploy not proven, migration proof pending, LP proof pending, indexer DB proof pending, manual signing error risk.`,
  'ROADMAP_TO_LAUNCH.md': `1. Manual deploy test\n2. Manual buy proof\n3. migration liquidity proof\n4. LP proof\n5. DB proof`,
  ...
  'MAINNET_MANUAL_TEST_FLOW.md': `Use prepare scripts, sign manually in wallet, store tx hashes, verify on-chain state, then confirm migration pool proof.`
};
