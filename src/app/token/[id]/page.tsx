    ...
    <div className="space-y-4 pb-24 pt-4">
      <div className="space-y-4 px-4">
        <div className="flex items-center gap-3">
          <div className="h-14 w-14 flex-shrink-0 overflow-hidden rounded-xl border border-[#1e3a5f]">
            <Image src={token.image || "/brand/img_04.png"} alt={token.name} width={56} height={56} className="h-full w-full object-cover" />
          </div>
