...
function statusMeta(token: TokenRecord, locale: "ru" | "en") {
  ...
  if (pct >= 75) return { label: locale === "ru" ? "Почти готов" : "Almost ready", className: "bg-[#3df6a2]/15 text-[#a5fbce]" };
  if (pct >= 40) return { label: locale === "ru" ? "Запуск идёт" : "Launching", className: "bg-[#7dd3fc]/15 text-[#7dd3fc]" };
