...
export function MobileShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(0,136,204,0.14),transparent_34%),linear-gradient(180deg,#07111d,#091321_48%,#08111c)] pb-[calc(84px+env(safe-area-inset-bottom))] text-white">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 mx-auto flex max-w-md items-center justify-around border-t border-white/8 bg-[#09111d]/96 backdrop-blur-xl" style={{ height: "calc(72px + env(safe-area-inset-bottom))", paddingBottom: "env(safe-area-inset-bottom)" }}>
