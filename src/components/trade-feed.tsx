...
export function TradeFeed({ trades }: { trades: TradeRecord[] }) {
  if (!trades.length) return <div className="glass-card rounded-[24px] p-6 text-center"><h3 className="text-xl font-semibold text-white">No trades yet</h3><p className="mt-2 text-sm text-[#8ba3c1]">The trade feed will appear after the first indexed buy.</p></div>;
