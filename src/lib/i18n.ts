...
export const messages = {
  ru: {
    ...
    home: {
      ...
      subtitle: "Security-first TON launchpad with no-custody manual flow, verified sandbox buy/mint loop, and configurable test-to-production target.",
      description: "Честный investor-review MVP: без fake live claims, с manual TonConnect flow, sandbox proof и понятным путём к funded mainnet dust-test.",
      ctaPrimary: "Открыть запуск",
      ctaSecondary: "Открыть статус",
  ...
  en: {
    ...
    home: {
      ...
      title: "Launch TON meme tokens. Graduate to STON.fi.",
      subtitle: "Security-first TON launchpad with no-custody manual flow, verified sandbox buy/mint loop, and configurable test-to-production target.",
      description: "An honest investor-review MVP with manual TonConnect flow, sandbox proof, and a clear path to a funded mainnet dust-test.",
      ctaPrimary: "Open launch flow",
      ctaSecondary: "Open status",
      statsA: "Sandbox verified",
      statsB: "Manual TonConnect ready",
      statsC: "Mainnet proof pending",
